        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none space-y-6 text-gray-700 dark:text-gray-300">
            <div>
              ...
              <p>
                BilusTech LLC ("we," "us," "our," or "Company") respects the privacy of our users
                ("user" or "you"). This Privacy Policy explains how we collect, use, disclose, and
                safeguard your information when you visit our website bilustech.com.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">2. Information We Collect</h2>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Information You Provide Directly:</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>Contact information (name, email address, phone number, company name)</li>
                <li>Information provided through contact forms and quote requests</li>
            ...
            <div>
              ...
              <p>
                BilusTech LLC implements appropriate technical and organizational measures to protect
            ...
            <div>
              ...
              <p>
                ...
                experience. You can control cookie settings through your browser preferences. Refusing cookies
                may impact your ability to use certain features of our site.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                practices of other sites. Please review their privacy policies before providing any personal information.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                BilusTech LLC may update this Privacy Policy periodically. We will notify you of significant
